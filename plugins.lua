...
require("lazy").setup({
  ...
  },
  {
    ...
    config = function()
      ...
      keymap("n", "<Leader>t",  ":Gcd <bar> NvimTreeToggle<Cr>", {noremap=true})
      keymap("n", "<Leader>tf",  ":Gcd <bar> NvimTreeFindFileToggle<Cr>", {noremap=true})
      keymap("n", "<Leader>tc",  ":Gcd <bar> NvimTreeCollapseKeepBuffers<Cr>", {noremap=true})
